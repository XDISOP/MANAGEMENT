...
from Natsuki.modules.helper_funcs.misc import mention_username
...
BANS_CALLBACK_HANDLER = CallbackQueryHandler(bans_callback, run_async=True, pattern=r"bans_")
...
dispatcher.add_handler(BANS_CALLBACK_HANDLER)
