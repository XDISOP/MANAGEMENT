        ...
        def awrapper(update: Update, context: CallbackContext, *args, **kwargs):
            ...
            if is_anon:
                ...
                anon_callback_messages[(message.chat.id, message.message_id)] = (
                    message.reply_text(text="You are an anonymous admin.",
...
def anon_callback(upd: Update, _: CallbackContext):
...
ANON_CB_HANDLER = CallbackQueryHandler(anon_callback, pattern=r"anoncb", run_async=True)
dispatcher.add_handler(ANON_CB_HANDLER)